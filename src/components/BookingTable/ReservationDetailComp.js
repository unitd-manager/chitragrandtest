        ...
        <FormGroup>
           ...
           <Col md="3">
                <FormGroup>
                  ...
                  <Input
                    type="text"
                    onChange={handleInputs}
                    value={bookingDetails && bookingDetails.delux}
                    name="delux"
              ...
              <Col md="3">
                <FormGroup>
                  ...
                  <Input
                    type="text"
                    onChange={handleInputs}
                    value={bookingDetails && bookingDetails.super_delux_double}
              ...
              <Col md="3">
                <FormGroup>
                  ...
                  <Input
                    type="text"
                    onChange={handleInputs}
                    value={bookingDetails && bookingDetails.delux_triple}
                    name="delux_triple"
           ...
           Room Type Details
                  ...
                  <Input
                    type="textarea"
                    onChange={handleInputs}
                    value={bookingDetails && bookingDetails.room_type}
                    name="room_type"
              ...
              <Col md="3">
                <FormGroup>
                  ...
                  <Input
                    type="textarea"
                    onChange={handleInputs}
                    value={bookingDetails && bookingDetails.room_count}
                    name="room_count"
                    style={{ height: '100px' }}
                  />
                </FormGroup>
